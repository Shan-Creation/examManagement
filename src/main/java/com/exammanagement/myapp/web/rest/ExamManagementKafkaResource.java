...
@RestController
@RequestMapping("/api/exam-management-kafka")
public class ExamManagementKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ExamManagementKafkaResource.class);
    ...
    public ExamManagementKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
